    ...
    <nav class="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
        <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-2">
            ...
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <div class="relative">
                    <input type="text" placeholder="Search" class="hidden md:flex py-2 mr-2 pl-10 pr-4 border rounded-full focus:outline-none focus:ring focus:border-blue-300">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white">
                    <li>
                        <a href="{{ route('feature')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">New & Feature</a>
                    </li>
                    <li>
                        <a href="{{ route('men_products')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Men</a>
                    </li>
                    <li>
                        <a href="{{ route('women_products')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover-bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Women</a>
                    </li>
                    <li>
                        <a href="{{ route('kid_products')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Kids</a>
                    </li>
                    @if (Auth::check())
                        {{-- <li>
                        ...
                        <li>
                            <a href="{{route('logout')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Sign Out</a>
                        </li>
                    @else
                        <li>
                            <a href="{{route('show-login')}}" class="block text-xl py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0">Sign In</a>
                        </li>
                    @endif
