...
@section('content')
    ...
    <div class="mb-2 flex">
        <a href="{{ route('customers.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded cursor-pointer duration-300 ease-in-out">
            Create
        </a>
        <div class="ml-4 mr-2">
                ...
                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                    ...
                    <tr>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                            <p class="mb-0 ml-4 font-semibold leading-tight text-xs">{{ $startIndex + $index }}</p>
                        </td>
                        <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function () {
                const customer_id = this.getAttribute('data-cus-id');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const deleteForm = document.getElementById('deleteForm' + customer_id);
                        deleteForm.submit();
                    }
                });
            });
