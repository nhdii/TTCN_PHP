                ...
                <div class="p-6.5">
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        <div class="w-full xl:w-1/2">
                            ...
                            <input name="product_name" value="{{ old('product_name', $product->product_name) }}" type="text" placeholder="Enter your Name" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter">
                        ...
                        <div class="w-full xl:w-1/2">
                            ...
                            <div class="relative z-20 bg-transparent">
                                <select name="gender" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary">
                                    ...
                                    <option value="Kid" {{ $product->gender === 'Kid' ? 'selected' : '' }}>Kid</option>
                                </select>
                    ...
                    <div class="mb-5">
                        ...
                        <input name="default_price" value="{{ old('default_price', $product->default_price) }}" type="text" placeholder="Enter Price" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter">
                    ...
                    <div class="mb-5 relative z-20 bg-transparent">
                        ...
                        <select name="brand_id" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary">
                            @foreach($brands as $br)
                                <option value="{{ $br->brand_id }}" @if(old('brand_id', $product->brand_id) == $br->brand_id) selected @endif>{{ $br->brand_name }}</option>
                            @endforeach
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2">
                            <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="mb-5 relative z-20 bg-transparent">
                        ...
                        <select name="category_id" class="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary">
                            @foreach($categories as $ct)
                                <option value="{{ $ct->category_id }}" @if(old('category_id', $product->category_id) == $ct->category_id) selected @endif>{{ $ct->category_name }}</option>
                            @endforeach
                        </select>
                        <span class="absolute top-1/2 right-4 z-30 -translate-y-1/2">
                            <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="mb-4.5 flex flex-col gap-6 xl:flex-row">
                        <div class="w-full xl:w-1/2">
                            ...
                            <div>
                                <input value="{{ old('image', $product->image) }}" name="image" type="file" class="w-full cursor-pointer rounded-lg border-[1.5px] border-stroke bg-transparent font-medium outline-none transition file:mr-5 file:border-collapse file:cursor-pointer file:border-0 file:border-r file:border-solid file:border-stroke file:bg-whiter file:py-3 file:px-5 file:hover:bg-primary file:hover:bg-opacity-10 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter">
                                @if($errors->has('image'))
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="desciption" rows="2" placeholder="Enter desciption" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter">{{ old('desciption', $product->desciption) }}</textarea>
