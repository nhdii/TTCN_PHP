                ...
                <div class="p-6.5">
                    <div class="mb-6 flex flex-col gap-6 xl:flex-row">
                        <div class="w-full xl:w-1/2">
                            ...
                            <input name="category_name" value="{{ old('category_name') }}" type="text" placeholder="Enter category name" class="w-full rounded border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter">
