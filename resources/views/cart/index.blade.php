    ...
    <div class="flex shadow-md my-10">
        <div class="w-3/4 bg-white px-10 py-10">
            <div class="flex justify-between border-b pb-8">
                ...
                <h2 class="font-semibold text-2xl">1 Product</h2>
            </div>
            <div class="flex mt-10 mb-5">
                <h3 class="font-semibold text-gray-600 text-xs uppercase w-2/5">Thông Tin Product</h3>
            ...
            <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                <div class="flex w-2/5"> <!-- product -->
                    ...
                    <div class="flex flex-col justify-between ml-4 flex-grow">
                        ...
                        <span class="text-red-500 text-sm">Gender</span> 
                        <span class="text-red-500 text-sm">Size</span>    
                        <a href="#" class="font-semibold hover:text-red-500 text-gray-500 text-sm">Remove</a>
                    </div>
                </div>
